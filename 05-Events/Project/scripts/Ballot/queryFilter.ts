...
// Connects to an already deployed Ballot Contract
...
// Executed Filters on a couple of historic transactions that have been
// exectuted on the balot contract between block 12477100 and 12477126
function setFilters(
